...
(autoload 'eca-chat-cycle-behavior "eca-chat" "\
Cycle between existing chat behaviors to use." t)
...
Search the next pending approval tool call after cursor and approve it." t)
(autoload 'eca-chat-tool-call-reject-next "eca-chat" "\
Search the next pending approval tool call after cursor and reject it." t)
...
`Eca-Completion mode' mode.  If the prefix argument is positive,
